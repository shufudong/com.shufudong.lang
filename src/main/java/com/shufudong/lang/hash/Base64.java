...
/** 
 * @ClassName:   [中]Base64 
 * @Description: [中]有关Base64的加解密算法
 *  <p>
 * [中]这个类中，可以对String或byte[]进行Base64加解密
 * </p>
 * @author       [中]ShuFuDong
 * @date         [中]2015年8月30日 下午2:32:29 
 */
public class Base64 {
    ...
    /** 
    * [中]这个方法对二进制数组使用指定RFC-2045的Base64解码
    * @param data   [中]待解码的二进制数组
    * @return       [中]经过Base64解码处理后的byte[]
    */
    ...
    /** 
    * [中]这个方法对字符串使用指定RFC-2045的Base64解码
    * @param str    [中]待解码的字符串
    * @return       [中]经过Base64解码处理后的字符串
    */
    ...
    /** 
    * [中]这个方法对二进制数组使用RFC-2045标准的进行Base64编码
    * @param data   [中]待编码的二进制数组
    * @return       [中]经过Base64编码处理后的二进制数组
    */
    ...
    /** 
    * [中]这个方法对字符串使用指定RFC-2045的Base64编码
    * @param str    [中]待编码的字符串
    * @return       [中]经过Base64编码处理后的字符串
    */
