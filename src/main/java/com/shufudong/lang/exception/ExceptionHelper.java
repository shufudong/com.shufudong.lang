...
public class ExceptionHelper {
    ...
    * 
    * @param throwable          [中]<code>Throwable</code>对象
    * @return ChainedThrowable  [中]<code>ChainedThrowable</code>对象
    */
    ...
    * @return ChainedThrowable  [中]异常的起因
    */
