...
/**
 * @ClassName:      [中]ArrayUtil
 * @Description:    [中]有关数组处理的工具类。
 * <p>
...
public class ArrayUtil {
    ...
    /** 
    * @Fields EMPTY_OBJECT_ARRAY : [中]空的<code>Object</code>数组。
    */
    public static final Object[] EMPTY_OBJECT_ARRAY = new Object[0];

    /** 
    * @Fields EMPTY_CLASS_ARRAY : [中]空的<code>Class</code>数组。
    */
    @SuppressWarnings("rawtypes")
    public static final Class[] EMPTY_CLASS_ARRAY = new Class[0];

    /** 
    * @Fields EMPTY_STRING_ARRAY : [中]空的<code>String</code>数组。
    */
    public static final String[] EMPTY_STRING_ARRAY = new String[0];

    /** 
    * @Fields EMPTY_LONG_ARRAY : [中]空的<code>long</code>数组。
    */
    public static final long[] EMPTY_LONG_ARRAY = new long[0];

    /** 
    * @Fields EMPTY_LONG_OBJECT_ARRAY : [中]空的<code>Long</code>数组。
    */
    public static final Long[] EMPTY_LONG_OBJECT_ARRAY = new Long[0];

    /** 
    * @Fields EMPTY_INT_ARRAY : [中]空的<code>int</code>数组。
    */
    public static final int[] EMPTY_INT_ARRAY = new int[0];

    /** 
    * @Fields EMPTY_INTEGER_OBJECT_ARRAY : [中]空的<code>Integer</code>数组。
    */
    public static final Integer[] EMPTY_INTEGER_OBJECT_ARRAY = new Integer[0];

    /** 
    * @Fields EMPTY_SHORT_ARRAY : [中]空的<code>short</code>数组。
    */
    public static final short[] EMPTY_SHORT_ARRAY = new short[0];

    /** 
    * @Fields EMPTY_SHORT_OBJECT_ARRAY : [中]空的<code>Short</code>数组。
    */
    public static final Short[] EMPTY_SHORT_OBJECT_ARRAY = new Short[0];

    /** 
    * @Fields EMPTY_BYTE_ARRAY : [中]空的<code>byte</code>数组。
    */
    public static final byte[] EMPTY_BYTE_ARRAY = new byte[0];

    /** 
    * @Fields EMPTY_BYTE_OBJECT_ARRAY : [中]空的<code>Byte</code>数组。
    */
    public static final Byte[] EMPTY_BYTE_OBJECT_ARRAY = new Byte[0];

    /** 
    * @Fields EMPTY_DOUBLE_ARRAY : [中]空的<code>double</code>数组。
    */
    public static final double[] EMPTY_DOUBLE_ARRAY = new double[0];

    /** 
    * @Fields EMPTY_DOUBLE_OBJECT_ARRAY : [中]空的<code>Double</code>数组。
    */
    public static final Double[] EMPTY_DOUBLE_OBJECT_ARRAY = new Double[0];

    /** 
    * @Fields EMPTY_FLOAT_ARRAY : [中]空的<code>float</code>数组。
    */
    public static final float[] EMPTY_FLOAT_ARRAY = new float[0];

    /** 
    * @Fields EMPTY_FLOAT_OBJECT_ARRAY : [中]空的<code>Float</code>数组。
    */
    public static final Float[] EMPTY_FLOAT_OBJECT_ARRAY = new Float[0];
    
    /** 
    * @Fields EMPTY_BOOLEAN_ARRAY : 空的<code>boolean</code>数组。
    */
    public static final boolean[] EMPTY_BOOLEAN_ARRAY = new boolean[0];

    /** 
    * @Fields EMPTY_BOOLEAN_OBJECT_ARRAY : [中]空的<code>Boolean</code>数组。
    */
    public static final Boolean[] EMPTY_BOOLEAN_OBJECT_ARRAY = new Boolean[0];

    /** 
    * @Fields EMPTY_CHAR_ARRAY : [中]空的<code>char</code>数组。
    */
    public static final char[] EMPTY_CHAR_ARRAY = new char[0];

    /** 
    * @Fields EMPTY_CHARACTER_OBJECT_ARRAY : [中]空的<code>Character</code>数组。
    */
    public static final Character[] EMPTY_CHARACTER_OBJECT_ARRAY = new Character[0];

    /** 
    * @Fields INITIAL_NON_ZERO_ODD_NUMBER : [中]计算hashcode所用的常量。
    */
    private static final int INITIAL_NON_ZERO_ODD_NUMBER = 17;

    /** 
    * @Fields MULTIPLIER_NON_ZERO_ODD_NUMBER : [中]计算hashcode所用的常量。
    */
    ...
    /**
     * [中]检查数组是否不是<code>null</code>和空数组<code>[]</code>。
     * <pre>
     ...
     * ==========================================================================
     * [中]默认值函数。 
     * [中]当数组为null或empty时，将数组转换成指定的默认数组。
     * ==========================================================================
     */
    /**
     * [中]如果数组是<code>null</code>，则返回空数组<code>[]</code>，否则返回数组本身。
     * <pre>
     * ArrayUtil.defaultIfNull(null)           = []
     * ArrayUtil.defaultIfNull(new String[0])  = [中]数组本身
     * ArrayUtil.defaultIfNull(new String[10]) = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new long[0])     = [中]数组本身
     * ArrayUtil.defaultIfNull(new long[10])    = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new int[0])      = [中]数组本身
     * ArrayUtil.defaultIfNull(new int[10])     = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new byte[0])     = [中]数组本身
     * ArrayUtil.defaultIfNull(new byte[10])    = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new double[0])   = [中]数组本身
     * ArrayUtil.defaultIfNull(new double[10])  = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new float[0])    = [中]数组本身
     * ArrayUtil.defaultIfNull(new float[10])   = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new boolean[0])  = [中]数组本身
     * ArrayUtil.defaultIfNull(new boolean[10]) = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null)            = []
     * ArrayUtil.defaultIfNull(new char[0])     = [中]数组本身
     * ArrayUtil.defaultIfNull(new char[10])    = [中]数组本身
     * </pre>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     */
    ...
    /**
     * [中]如果数组是<code>null</code>，则返回指定默认数组，否则返回数组本身。
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)           = defaultArray
     * ArrayUtil.defaultIfNull(new String[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new String[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     */
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)         = defaultArray
     * ArrayUtil.defaultIfNull(new long[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new long[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)        = defaultArray
     * ArrayUtil.defaultIfNull(new int[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new int[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)          = defaultArray
     * ArrayUtil.defaultIfNull(new short[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new short[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)         = defaultArray
     * ArrayUtil.defaultIfNull(new byte[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new byte[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)              = defaultArray
     * ArrayUtil.defaultIfNull(new double[0], defaultArray)     = [中]数组本身
     * ArrayUtil.defaultIfNull(new double[10], defaultArray)    = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)          = defaultArray
     * ArrayUtil.defaultIfNull(new float[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new float[10], defaultArray) = [中]数组本身
     * </pre> 
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)            = defaultArray
     * ArrayUtil.defaultIfNull(new boolean[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new boolean[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
     ...
     * <pre>
     * ArrayUtil.defaultIfNull(null, defaultArray)         = defaultArray
     * ArrayUtil.defaultIfNull(new char[0], defaultArray)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new char[10], defaultArray) = [中]数组本身
     * </pre>
     * @param array         [中]要转换的数组
     * @param defaultArray  [中]默认数组
     * @return              [中]数组本身或指定的默认数组
    ...
    /**
     * [中]如果数组是<code>null</code>，则返回指定元素类型的空数组，否则返回数组本身。
     * <pre>
     * ArrayUtil.defaultIfNull(null, String.class)           = new String[0]
     * ArrayUtil.defaultIfNull(new String[0], String.class)  = [中]数组本身
     * ArrayUtil.defaultIfNull(new String[10], String.class) = [中]数组本身
     * </pre>
     * @param array                 [中]要转换的数组
     * @param defaultComponentType  [中]默认数组的元素类型
     * @return                      [中]数组本身或指定类型的空数组
     */
    ...
    /**
     * [中]如果数组是<code>null</code>或空数组<code>[]</code>，则返回空数组<code>[]</code>，否则返回数组本身。
     * <p>
     * [中]此方法实际上和<code>defaultIfNull(Object[])</code>等效。
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)           = []
     * ArrayUtil.defaultIfEmpty(new String[0])  = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new String[10]) = [中]数组本身
     * </pre>
     * </p>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)           = []
     * ArrayUtil.defaultIfEmpty(new long[0])    = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new long[10])   = [中]数组本身
     * </pre>
     * </p>
     * @param array     [中]要转换的数组
     * @return          [中]数组本身或空数组<code>[]</code>
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)          = []
     * ArrayUtil.defaultIfEmpty(new int[0])    = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new int[10])   = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)               = []
     * ArrayUtil.defaultIfEmpty(new short[0])       = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new short[10])      = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)           = []
     * ArrayUtil.defaultIfEmpty(new byte[0])    = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new byte[10])   = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)               = []
     * ArrayUtil.defaultIfEmpty(new double[0])      = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new double[10])     = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)               = []
     * ArrayUtil.defaultIfEmpty(new float[0])       = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new float[10])      = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)               = []
     * ArrayUtil.defaultIfEmpty(new boolean[0])     = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new boolean[10])    = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * <pre>
     * ArrayUtil.defaultIfEmpty(null)           = []
     * ArrayUtil.defaultIfEmpty(new char[0])    = [中]数组本身
     * ArrayUtil.defaultIfEmpty(new char[10])   = [中]数组本身
     * </pre>
     * 
     * </p>
     * 
     ...
     * ArrayUtil.defaultIfEmpty(new long[10], defaultArray)   = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new int[10], defaultArray)    = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new short[10], defaultArray)  = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new byte[10], defaultArray)   = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new double[10], defaultArray) = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new boolean[10], defaultArray)   = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
     ...
     * ArrayUtil.defaultIfEmpty(new char[10], defaultArray)   = [中]数组本身
     * </pre>
     * 
     * @param array
     *            [中]要转换的数组
    ...
    /**
     * [中]如果数组是<code>null</code>或空数组<code>[]</code>，则返回指定元素类型的空数组，否则返回数组本身。
     * 
     * <pre>
     * ArrayUtil.defaultIfNull(null, String.class)           = new String[0]
    ...
    /**
     * [中]递归地比较两个数组是否相同，支持多维数组。
     * 
     * <p>
     * [中]如果比较的对象不是数组，则此方法的结果同<code>ObjectUtil.equals</code>。
     * </p>
     * 
     * @param array1
     *            [中]数组1
     ...
     * ==========================================================================
     * [中]Hashcode函数。
     * [中]以下方法用来取得数组的hash code。
     *
     * ==========================================================================
     */
    /**
     * [中]取得数组的hash值, 如果数组为<code>null</code>, 则返回<code>0</code>。
     * 
     * <p>
     * [中]如果对象不是数组，则此方法的结果同<code>ObjectUtil.hashCode</code>。
     * </p>
     * 
     * @param array
     *            [中]数组
     ...
     */
    /**
     * [中]将数组映射成固定长度的<code>List</code>，当改变这个<code>List</code>中的值时。数组中的相应值也被改变。
     * 
     * <p>
     * [中]如果输入数组为<code>null</code>，则返回<code>null</code>。
     * </p>
     * 
     * <p>
     * [中]该方法内部调用<code>java.util.Arrays.asList</code>
     * [中]方法所返回的列表为指定数组的映像（固定长度），因此性能和内存占用上比<code>toList</code>方法更优。
     * </p>
     * 
     * <p>
     * [中]这个方法常被用于初始化，例如：
     ...
     * 
     * <p>
     * [中]该方法返回的列表为指定数组的复本，而<code>java.util.Arrays.asList</code>
     * [中]方法所返回的列表为指定数组的映像（固定长度）。
     * </p>
     * 
     * <p>
     * [中]这个方法常被用于初始化，例如：
     ...
     * List singleList = ArrayUtil.toList(&quot;hello&quot;); // [中]返回单个元素的列表[&quot;hello&quot;]
     * </pre>
     * 
     * </p>
     * 
     ...
     * List singleList = ArrayUtil.toList(&quot;hello&quot;, new ArrayList()); // [中]返回单个元素的列表[&quot;hello&quot;]
     * </pre>
     * 
     * </p>
     * 
     ...
     *            [中]要转换的数组
     * @param list
     *            [中]要填充的列表，如果是<code>null</code>，则创建之
     * 
     * @return [中]被创建或填充的list
     */
    ...
    /**
     * [中]将数组转换成<code>Map</code>。数组的元素必须是<code>Map.Entry</code>或元素个数多于2的子数组。
     * 
     * <p>
     * [中]如果输入数组为<code>null</code>，则返回<code>null</code>。
     * </p>
     ...
     *             [中]如果有一个子数组元素个数小于2或不是<code>Map.Entry</code>实例
     */
     ...
     *            [中]要转换的数组
     * @param map
     *            [中]要填充的map，如果为<code>null</code>则自动创建之
     * 
     * @return [中]被创建或填充的map
     * 
     * @throws IllegalArgumentException
     ...
     * ==========================================================================
     * [中]Clone函数。
     * [中]以下方法调用Object.clone方法，进行“浅复制”（shallow copy）。
     * ==========================================================================
     */

    /**
     * [中]复制一个数组。如果数组为<code>null</code>，则返回<code>null</code>。
     * 
     * <p>
     * [中]此方法只进行“浅复制”，也就是说，数组中的对象本身不会被复制。 另外，此方法也不处理多维数组。
     * </p>
     * 
     * @param array
     *            [中]要复制的数组
     ...
     */
    /**
     * [中]判断两个数组是否具有相同的长度。如果数组为<code>null</code>则被看作长度为<code>0</code>。
     * 
     * @param array1
     *            [中]数组1
     * @param array2
     *            [中]数组2
     * 
     * @return [中]如果两个数组长度相同，则返回<code>true</code>
     */
     ...
     */
    /**
     * [中]反转数组的元素顺序。如果数组为<code>null</code>，则什么也不做。
     * 
     * @param array
     *            [中]要反转的数组
     */
     ...
     * 
     * <p>
     * [中]如果未找到或数组为<code>null</code>则返回<code>-1</code>。
     * </p>
     * 
     * @param array
     *            [中]要扫描的数组
     ...
     *            [中]要查找的元素
     * 
     * @return [中]该元素在数组中的序号，如果数组为<code>null</code>或未找到，则返回<code>-1</code>。
     */
     ...
     *            [中]要查找的元素序列
     * 
     * @return [中]该元素序列在数组中的序号，如果数组为<code>null</code>或未找到，则返回<code>-1</code>。
     */
     ...
     * 
     * <p>
     * [中]起始索引小于<code>0</code>则看作<code>0</code>，超出数组长度的起始索引则返回<code>-1</code>。
     * </p>
     * 
     * @param array
     *            [中]要扫描的数组
     ...
     * 
     * <p>
     * [中]起始索引小于<code>0</code>则返回<code>-1</code>，超出数组长度的起始索引则从数组末尾开始找。
     * </p>
     * 
     * @param array
     *            [中]要扫描的数组
     ...
     * 
     * <p>
     * [中]如果数组为<code>null</code>则返回<code>false</code>。
     * </p>
     * 
     * @param array
     *            [中]要扫描的数组
     ...
     *            [中]要查找的元素
     * 
     * @return [中]如果找到则返回<code>true</code>
     */
     ...
     * </p>
     * 
     * @param array         [中]要扫描的数组
     * @param intToFind     [中]要查找的元素
     * @return              [中]该元素在数组中的序号，如果数组为<code>null</code>或未找到，则返回<code>-1</code>。
     */
     ...
     * 
     * <p>
     * [中]如果数组是<code>null</code>则返回<code>[]</code>，支持多维数组。 如果数组元素为<code>null</code>
     * ，则显示<code>&lt;null&gt;</code>。
     * 
     * <pre>
     ...
     * 
     * <p>
     * [中]如果数组是<code>null</code>则返回指定字符串，支持多维数组。 如果数组元素为<code>null</code>，则显示
     * <code>&lt;null&gt;</code>。
     * 
     * <pre>
     ...
     *            [中]要转换的数组
     * @param nullArrayStr
     *            [中]如果数组是<code>null</code>，则返回此字符串
     * 
     * @return [中]字符串表示，或返回指定字符串表示<code>null</code>
     */
     ...
     * 
     * <p>
     * [中]如果数组是<code>null</code>则返回指定字符串，支持多维数组。 如果数组元素为<code>null</code>，则显示指定字符串。
     * 
     * <pre>
     ...
     *            [中]如果数组中的元素为<code>null</code>，则返回此字符串
     * 
     * @return [中]字符串表示，或返回指定字符串表示<code>null</code>
     */
    ...
    /**
     * [中]将数组转换成易于阅读的字符串表示。<code>null</code>将被看作空数组。 支持多维数组。
     * 
     * @param buffer
     *            [中]将转换后的字符串加入到这个<code>StringBuffer</code>中
     * @param array
     *            [中]要转换的数组
     * @param nullArrayStr
     *            [中]如果数组是<code>null</code>，则返回此字符串
